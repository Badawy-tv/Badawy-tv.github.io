...
<button class="ayah-play" onclick="playAyah(${surahNumber},${ayah.numberInSurah})">▶</button> <button class="ayah-play" onclick="playAyah(,${ayah.numberInSurah})">▶</button> <span class="ayah-number">${ayah.numberInSurah}</span>`;
